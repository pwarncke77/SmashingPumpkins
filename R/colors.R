...
pumpkins_palettes <- list(
  ...
  siamese_dream = c("#F5F5F5", "#EC954E", "#69651C", "#B01709", "#792218", "#020F00", "#C34110", "#F0E6B1"),
  siamese_dream_dark = c("#B01709", "#69651C", "#792218", "#020F00"),
  siamese_dream_light = c("#F5F5F5", "#F0E6B1", "#EC954E", "#C34110"),
  simamese_dream_re = c("#F3711D", "#EB7AB0", "#CC382C", "#854786", "#303183"),
  mellon_collie = c( "#EEB31B", "#216683", "#9F3036",  "#2C4363", "#405E5C", "#F8CA72", "#2B7748", "#5C4E6F",
                     "#E33A35", "#F7BB87", "#BC8B49", "#5E798E", "#23342C", "#FFFBCB"),
